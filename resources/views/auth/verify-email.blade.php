...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .left-section{background:var(--dark);position:relative;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;padding:3rem;min-height:560px;}
        ...
        .email-anim{width:80px;height:80px;background:rgba(200,169,110,.1);border:2px solid rgba(200,169,110,.3);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 2rem;animation:pulse 2s infinite;}
        @keyframes pulse{0%,100%{box-shadow:0 0 0 0 rgba(200,169,110,.3);}50%{box-shadow:0 0 0 12px rgba(200,169,110,0);}}
        .email-anim svg{width:36px;height:36px;}
        .form-header{margin-bottom:1.75rem;text-align:center;}
        .form-header h2{font-family:'DM Serif Display',serif;font-size:2rem;color:var(--dark);margin-bottom:.75rem;}
        .form-header p{color:var(--muted);font-size:.9rem;line-height:1.7;}
        .alert-success{background:#f0fdf4;border:1px solid #bbf7d0;border-radius:.6rem;padding:.75rem 1rem;margin-bottom:1.5rem;font-size:.85rem;color:#16a34a;text-align:center;}
        .btn-primary{width:100%;padding:.9rem;background:var(--dark);color:white;border:none;border-radius:.6rem;font-size:.95rem;font-weight:700;font-family:'DM Sans',sans-serif;cursor:pointer;letter-spacing:.02em;transition:all .25s;margin-bottom:1rem;}
        ...
        .btn-logout{width:100%;padding:.8rem;background:transparent;color:var(--muted);border:1.5px solid var(--border);border-radius:.6rem;font-size:.9rem;font-family:'DM Sans',sans-serif;cursor:pointer;transition:all .25s;}
        .btn-logout:hover{border-color:var(--dark);color:var(--dark);}
        .check-list{margin-top:1.5rem;padding:1rem 1.25rem;background:var(--cream);border-radius:.75rem;border:1px solid var(--border);}
        .check-list p{font-size:.8rem;color:var(--muted);margin-bottom:.5rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;}
        .check-item{display:flex;align-items:center;gap:.5rem;font-size:.85rem;color:var(--dark);padding:.25rem 0;}
        .check-item span{color:var(--accent);font-size:1rem;}
...
<div class="container"><div class="main-card">
    ...
    <div class="right-section">
        ...
        <div class="email-anim">
            <svg viewBox="0 0 24 24" fill="none" stroke="#c8a96e" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
        </div>
        <div class="form-header">
            <h2>Verifikasi Email Anda</h2>
            <p>Kami telah mengirimkan link verifikasi ke email Anda. Silakan cek inbox (atau folder spam) dan klik link tersebut untuk mengaktifkan akun.</p>
        </div>
        ...
        <div class="check-list">
            <p>Tips</p>
            <div class="check-item"><span>✦</span> Cek folder spam / junk mail</div>
            <div class="check-item"><span>✦</span> Link berlaku selama 60 menit</div>
            <div class="check-item"><span>✦</span> Klik tombol di atas jika email tidak masuk</div>
        </div>
    </div>
</div></div>
</body>
