...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .left-section{background:var(--dark);position:relative;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end;padding:3rem;min-height:600px;}
...
<div class="container"><div class="main-card">
    ...
    <div class="right-section">
        ...
        <div class="form-header">
            ...
            <p>Masukkan password baru Anda di bawah ini. Pastikan menggunakan kombinasi yang kuat.</p>
        </div>
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input id="email" class="form-input @error('email') error @enderror" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus placeholder="Masukan Kembali Email Anda" />
            ...
            <div class="form-group">
                ...
                <div class="pw-wrap">
                    <input id="password_confirmation" class="form-input" type="password" name="password_confirmation" required placeholder="Ulangi password baru" />
